			...
			"rss": [
				...
				}},
				{
					"channel": [
						...
						{
							"lastBuildDate": moment(this.body.lastBuildDate, (typeof this.body.lastBuildDate === "number") ? "UNIX" : "ddd, DD MMM YYYY HH:mm:ss ZZ").tz("UTC").format("ddd, DD MMM YYYY HH:mm:ss ZZ"),
						},
						{
